  ...
  */
  function initVideoModal () {
    ...
    modalButton.addEventListener('click', function(event) {
      ...
      videoWrapper.innerHTML = '<iframe style="height: 100%; left: 0; position: absolute; top: 0; width: 100%;" src="//player.youku.com/embed/XMzMwMTYyODMyNA==?client_id=37ae6144009e277d" frameborder="0" allowfullscreen></iframe>'
      isOpen = true
    })
